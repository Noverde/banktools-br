...
describe BanktoolsBR::Banks::Bradesco::Agency do
  describe '#valid?' do
    it 'returns true if agency length is equal to 4' do
      expect(described_class.new('0272')).to be_valid
      expect(described_class.new('1288')).to be_valid
      expect(described_class.new('0999')).to be_valid
    end
